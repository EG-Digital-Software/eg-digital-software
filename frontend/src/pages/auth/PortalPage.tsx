        ...
        <div className="relative flex h-[100svh] items-center justify-center overflow-hidden px-4 py-3 sm:py-6 lg:h-auto lg:min-h-screen lg:justify-end lg:overflow-visible lg:px-0 lg:pr-6">
          <div className="relative z-10 flex max-h-full w-full max-w-[700px] flex-col justify-center animate-in fade-in slide-in-from-bottom-4 duration-500 lg:block">
            ...
            <div className="mb-3 shrink-0 text-center lg:hidden">
              <h2 className="!font-extrabold leading-[1.1] tracking-tight text-slate-900 text-xl">
                One Platform.
                <br />
                One Login.
                <br />
              ...
              <p className="mx-auto mt-1.5 max-w-xs text-xs leading-relaxed text-slate-700">
                Powering digital transformation across Australia and beyond.
              </p>
            </div>

            <div className="flex w-full min-h-0 flex-col overflow-hidden rounded-3xl border border-white/70 bg-white px-5 py-4 shadow-2xl shadow-slate-900/10 backdrop-blur-xl sm:px-10 sm:py-10 lg:min-h-[70vh] lg:px-16 lg:py-8 dark:border-slate-800 dark:bg-slate-900">
             <div className="flex w-full flex-1 flex-col justify-between gap-2.5 sm:gap-6">
              <div className="flex flex-col items-center text-center">
                <Logo className="text-xl sm:text-4xl" />
                <h1 className="mt-1.5 !font-bold text-2xl leading-tight text-slate-900 sm:mt-4 sm:text-[2.75rem] dark:text-white">
                  Welcome Back
                </h1>
                <p className="mt-1 hidden text-sm text-slate-500 sm:block sm:mt-2 sm:text-lg dark:text-slate-400">
              ...
              <div className="grid grid-cols-2 gap-1.5 rounded-xl border border-slate-200 bg-white p-1.5 dark:border-slate-700 dark:bg-white">
                {TABS.map((t) => (
                  <button
                    ...
                    className={cn(
                      'flex items-center justify-center gap-1.5 whitespace-nowrap rounded-lg px-1.5 py-2 text-sm font-medium transition sm:py-3 sm:text-base',
                      tab === t.key
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-2.5 sm:space-y-4">
                ...
                <div className="space-y-1 sm:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50 pl-11 pr-12 text-base sm:h-16 text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-slate-400 focus:bg-white focus:ring-2 focus:ring-slate-900/5 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:focus:bg-slate-800"
                      {...register('password')}
                    />
                    <button
                      type="button"
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 text-xs text-slate-600 sm:text-sm dark:text-slate-400">
                    <input
                      type="checkbox"
                  ...
                  <Link
                    ...
                    className="text-xs font-medium text-slate-600 hover:text-slate-900 hover:underline sm:text-sm dark:text-slate-400 dark:hover:text-white"
                  >
                    Forgot Password?
                  </Link>
                </div>
            ...
            <div className="mt-3 shrink-0 text-center lg:hidden">
              <Link
                to="/admin/login"
